...
namespace Game3
{
    public partial class Form7 : Form
    {
        ...
        public Form7()
        {
            ...
            label2.Text = num1 + " X " + num2 + " = ";
            label3.Text = Math.Max(num3, num4) + " - " + Math.Min(num3, num4) + " = ";
            label4.Text = num7 * num8 + " / " + num8 + " = ";
            label5.Text = num9 + " X (" + (Math.Max(num10, num11) + " - " + Math.Min(num10, num11)) + ") + " + num12 + " = ";
        }
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            ...
            {
                if (double.Parse(textBox4.Text) == num9 * (Math.Max(num10, num11) - Math.Min(num10, num11)) + num12)
                {
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            {
                if (double.Parse(textBox3.Text) == num7)
                {
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            {
                if (int.Parse(textBox2.Text) == Math.Max(num3, num4) - Math.Min(num3, num4))
                {

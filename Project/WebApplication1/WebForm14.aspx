...
<body>
    <form id="form1" runat="server">
        ...
        <p>
            &nbsp;</p>
        <p>
        <asp:Label ID="Label1" runat="server" BorderStyle="None" Font-Size="XX-Large" style="z-index: 1; left: 40%; top: 60px; position: absolute; height: 40px; width: 350px; text-align: center; bottom: 239px;" Text="הוספת הורה"></asp:Label>
        </p>
        <p>
                    <asp:Label ID="Label6" runat="server" BorderStyle="None" Font-Size="Large" style="z-index: 1; left: 38%; top: 95px; position: absolute; height: 40px; width: 386px; text-align: center; bottom: 165px;" Text="שימו לב! ניתן להוסיף הורה רק לילד אשר כבר רשום במערכת"></asp:Label>
            ...
            <asp:Label ID="Label3" runat="server" Font-Size="Large" style="z-index: 1; left: 53%; top: 150px; position: absolute" Text=":שם פרטי (הורה)"></asp:Label>
            <asp:Label ID="Label4" runat="server" Font-Size="Large" style="z-index: 1; left: 53%; top: 300px; position: absolute; height: 16px" Text=":תעודת זהות(ילד)"></asp:Label>
        </p>
        <p>
            <asp:Label ID="Label5" style="z-index: 1; left: 53%; top: 240px; position: absolute" runat="server" Text=":תעודת זהות (הורה)"></asp:Label>
